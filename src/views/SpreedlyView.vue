...
export default {
  ...
  mounted() {
    ...
    setTimeout(function() {
        ...
        //await loginToAcmeBackend(serverUrl, headers)

        const addCardHeaders = {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
          'Authorization': 'Bearer ' + accessToken,
          'Cookie': 'test=' + accessToken
        }

        Axios
          .post(`${serverUrl}/user/addCard`, addCard, { addCardHeaders })
          .then((response) => {
